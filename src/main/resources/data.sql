...
INSERT INTO MEMBER ("id","date_of_birth","plan","email","given_name","phone_number","status","surname","title","address_id","last_employer") VALUES ('201', '1991-01-01','Standard','minerva@bartoletti.net','Eloy','12345678','ACTIVE','Abbott','Mr','101','PWC');
INSERT INTO MEMBER ("id","date_of_birth","plan","email","given_name","phone_number","status","surname","title","address_id","last_employer") VALUES ('202', '1992-01-01','Standard','randal@murray.co','Jorge','12345678','ACTIVE','Torp','Mr','102','Melbourne Water');
INSERT INTO MEMBER ("id","date_of_birth","plan","email","given_name","phone_number","status","surname","title","address_id","last_employer") VALUES ('203', '1993-01-01','Standard','prince@binspagac.com','Arnold','12345678','ACTIVE','Kling','Mr','103','Australian Super');
INSERT INTO MEMBER ("id","date_of_birth","plan","email","given_name","phone_number","status","surname","title","address_id","last_employer") VALUES ('204', '1994-01-01','Standard','helena_mueller@bayer.org','Glen','12345678','ACTIVE','Bergstrom','Mr','104','Richmond Tigers');
INSERT INTO MEMBER ("id","date_of_birth","plan","email","given_name","phone_number","status","surname","title","address_id","last_employer") VALUES ('205', '1995-01-01','Standard','verona_huel@orn.biz','Sylvester','12345678','ACTIVE','Boyle','Mr','105','Melbourne Uni');
INSERT INTO MEMBER ("id","date_of_birth","plan","email","given_name","phone_number","status","surname","title","address_id","last_employer") VALUES ('206', '1996-01-01','Standard','elwin_herman@reichelhamill.io','Sammy','12345678','ACTIVE','Doyle','Mr','110','United Energy');
INSERT INTO MEMBER ("id","date_of_birth","plan","email","given_name","phone_number","status","surname","title","address_id","last_employer") VALUES ('207', '1997-01-01','Standard','brad.bins@lynchkaulke.info','Zoila','12345678','ACTIVE','Cormier','Ms','111','AAPT');
INSERT INTO MEMBER ("id","date_of_birth","plan","email","given_name","phone_number","status","surname","title","address_id","last_employer") VALUES ('208', '1998-01-01','Standard','alanis@casperbreitenberg.io','Alessandro','12345678','ACTIVE','Mante','Ms','112','Suncorp');
INSERT INTO MEMBER ("id","date_of_birth","plan","email","given_name","phone_number","status","surname","title","address_id","last_employer") VALUES ('209', '1990-01-01','Standard','albina.dickinson@sanfordkozey.info','Dayna','12345678','ACTIVE','Grady','Ms','113','Bluewolf');
INSERT INTO MEMBER ("id","date_of_birth","plan","email","given_name","phone_number","status","surname","title","address_id","last_employer") VALUES ('210', '1991-02-02','Standard','ludie_hauck@mann.info','Lennie','12345678','ACTIVE','Keebler','Ms','114','Salesforce');
